...
class NombreSousZoneTest {
    ...
    void testIsValidMemeNombre() {
        Rule rule1 = new NombreSousZone("La notice doit contenir autant de 606 $3 que de 712 $3", "606", Priority.P1, "3", "712", "3");
        Assertions.assertTrue(rule1.isValid(notice));
        Rule rule2 = new NombreSousZone("La notice doit contenir autant 606 $a de que de 676 $a", "606", Priority.P1, "a", "676", "a");
    ...
    void testIsValidSousZoneIntrouvable() {
        ...
        Rule rule1 = new NombreSousZone("La notice doit contenir autant de 606 $b que de 676 $b", "606", Priority.P1, "b", "676", "b");
        Assertions.assertFalse(rule1.isValid(notice));
    }

    @Test
    void testIsValidZoneSourceRepetee() {
        Rule rule1 = new NombreSousZone("La notice doit contenir autant de 300 $a que de 801 $b", "300", Priority.P1, "a", "801", "b");
        Assertions.assertFalse(rule1.isValid(notice));
    }

    @Test
    void testIsValidZoneCibleRepetee() {
        Rule rule1 = new NombreSousZone("La notice doit contenir autant de 801 $b que de 300 $b", "801", Priority.P1, "b", "300", "b");
        Assertions.assertTrue(rule1.isValid(notice));
    }

    @Test
    void testIsValidZonesAbsents() {
        Rule rule1 = new NombreSousZone("aucune des zones n'est présente dans la notice", "675", Priority.P1, "a", "674", "a");
        Assertions.assertFalse(rule1.isValid(notice));
    }
}