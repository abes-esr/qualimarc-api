...
public class TypeCaractereTest {
    ...
    void isValid() {
        TypeCaractere rule = new TypeCaractere(1,"300",false,"b");
    ...
    void isValid2() {
        TypeCaractere rule = new TypeCaractere(1,"033",false,"d");
        rule.addTypeCaractere(TypeCaracteres.ALPHABETIQUE);
    ...
    void isValid2etDemi() {
        TypeCaractere rule = new TypeCaractere(1,"200",false,"x");
        rule.addTypeCaractere(TypeCaracteres.ALPHABETIQUE);

        TypeCaractere rule1 = new TypeCaractere(1,"200",false,"y");
    ...
    void isValid4() {
        TypeCaractere rule = new TypeCaractere(1,"101",false,"a");
        rule.addTypeCaractere(TypeCaracteres.ALPHABETIQUE_MAJ);
    ...
    void isValid6() {
        TypeCaractere rule = new TypeCaractere(1,"102",false,"a");
        rule.addTypeCaractere(TypeCaracteres.ALPHABETIQUE_MIN);
    ...
    void isValid7() {
        TypeCaractere rule = new TypeCaractere(1,"035",false,"a");
    ...
    void isValid9() {
        TypeCaractere rule = new TypeCaractere(1,"033",false,"a");
    ...
    void isValid10() {
        TypeCaractere rule = new TypeCaractere(1,"010",false,"a");
        rule.addTypeCaractere(TypeCaracteres.SPECIAL);

        Assertions.assertTrue(rule.isValid(notice));

        TypeCaractere rule1 = new TypeCaractere(1,"010",false,"b");
        rule1.addTypeCaractere(TypeCaracteres.SPECIAL);

        Assertions.assertFalse(rule1.isValid(notice));

        TypeCaractere rule2 = new TypeCaractere(1,"010",false,"d");
    ...
    void isValid11() {
        TypeCaractere rule = new TypeCaractere(1,"181",false,"a");
        rule.addTypeCaractere(TypeCaracteres.SPECIAL);
    ...
    void isValid13() {
        TypeCaractere rule = new TypeCaractere(1,"214",false,"c");
        rule.addTypeCaractere(TypeCaracteres.ALPHABETIQUE);

        TypeCaractere rule1 = new TypeCaractere(1,"214",false,"c");
        rule1.addTypeCaractere(TypeCaracteres.ALPHABETIQUE_MIN);
        rule1.addTypeCaractere(TypeCaracteres.ALPHABETIQUE_MAJ);
    ...
    @Test
    void testGetZones() {
        TypeCaractere rule = new TypeCaractere(1, "100", false,"a");
