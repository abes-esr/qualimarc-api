...
public class PositionSousZoneTest {
    ...
    void isValid() throws IOException {
        ...
        PositionSousZone rule = new PositionSousZone(1, "606", false, "3", Lists.newArrayList(positionsOperator1), BooleanOperateur.OU);
        Assertions.assertTrue(rule.isValid(notice));

        PositionSousZone rule2 = new PositionSousZone(1, "801",false, "3", Lists.newArrayList(positionsOperator1), BooleanOperateur.OU);
        Assertions.assertFalse(rule2.isValid(notice));

        PositionSousZone rule3 = new PositionSousZone(1, "801",false, "a", Lists.newArrayList(positionsOperator2), BooleanOperateur.OU);
        Assertions.assertFalse(rule3.isValid(notice));

        PositionSousZone rule4 = new PositionSousZone(1, "713",false, "a", Lists.newArrayList(positionsOperator2), BooleanOperateur.OU);
        Assertions.assertFalse(rule4.isValid(notice));

        PositionSousZone rule5 = new PositionSousZone(1, "801",false, "2", Lists.newArrayList(positionsOperatorMoins1), BooleanOperateur.OU);
        Assertions.assertTrue(rule5.isValid(notice));

        PositionSousZone rule6 = new PositionSousZone(1, "801",false, "c", Lists.newArrayList(positionsOperatorMoins1), BooleanOperateur.OU);
        Assertions.assertFalse(rule6.isValid(notice));

        PositionSousZone rule7 = new PositionSousZone(1, "801",false, "c", Lists.newArrayList(positionsOperator1, positionsOperator3), BooleanOperateur.OU);
        Assertions.assertTrue(rule7.isValid(notice));

        PositionSousZone rule8 = new PositionSousZone(1, "801",false, "c", Lists.newArrayList(positionsOperator1, positionsOperator3), BooleanOperateur.ET);
        Assertions.assertFalse(rule8.isValid(notice));

        PositionSousZone rule9 = new PositionSousZone(1, "607",false, "x", Lists.newArrayList(positionsOperator3, positionsOperatorMoins1), BooleanOperateur.ET);
        Assertions.assertTrue(rule9.isValid(notice));

        PositionSousZone rule10 = new PositionSousZone(1, "607",false, "a", Lists.newArrayList(positionsOperator3, positionsOperatorMoins1), BooleanOperateur.ET);
        ...
        PositionSousZone rule11 = new PositionSousZone(1, "607",false, "a", Lists.newArrayList(positionsOperator1different), BooleanOperateur.ET);
        ...
        PositionSousZone rule12 = new PositionSousZone(1, "607",false, "v", Lists.newArrayList(positionsOperator1inferieur), BooleanOperateur.ET);
    ...
    void getZones() {
        PositionsOperator positionsOperator2 = new PositionsOperator(2, 2, ComparaisonOperateur.EGAL);
        PositionSousZone rule = new PositionSousZone(1, "200",false, "a", Lists.newArrayList(positionsOperator2), BooleanOperateur.OU);
