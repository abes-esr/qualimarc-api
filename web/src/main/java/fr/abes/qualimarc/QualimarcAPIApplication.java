...
public class QualimarcAPIApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Rule rule1 = new PresenceZone("Zone 011 : à supprimer car un numéro ISSN ne peut apparaître que dans une notice de ressource continue.", "011", Priority.P1, familles.stream().filter(f -> !f.getId().equals("BD")).collect(Collectors.toSet()), true);
